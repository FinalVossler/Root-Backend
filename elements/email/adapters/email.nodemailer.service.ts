...
import createEmailService from "../ports/email.service";
import {
...
export const createNodeMailerSendEmailService: ICreateSendEmailService =
  async () => {
...
const emailNodemailerService = createEmailService(
  createNodeMailerSendEmailService
);

export default emailNodemailerService;
